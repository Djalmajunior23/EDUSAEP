  ...
  const navItems = React.useMemo(() => {
    ...
    if (role === 'STUDENT' || role === 'MONITOR') {
      return [
        ...
        { id: 'student-quizzes', label: 'Quizzes Rápidos', icon: ZapIcon, path: '/quizzes', description: 'Gamificação' },
        ...
        { id: 'student-sa', label: 'Situações Práticas', icon: ZapIcon, path: '/student-sa', description: 'Desafios' },
    ...
    return [
      ...
      { id: 'advanced-ia', label: 'IA Avançada', icon: ZapIcon, path: '/teacher-ai-assistant', description: 'Estudos de Caso' },
      ...
      { id: 'quizzes', label: 'Gestão de Quizzes', icon: ZapIcon, path: '/quizzes', description: 'Jogos Rápidos' },
